    ...
    <div className="font-sans">
      <nav className="flex justify-between items-center px-10 py-6 !bg-white shadow-md">
        ...
        <ul className="flex space-x-6 text-gray-700 font-medium">
          ...
          <li>
            <button onClick={() => scrollToSection('pricing')} className="hover:text-blue-600">
              Pricing
            </button>
          </li>
        </ul>
      ...
      <section id="pricing" className="py-20 !bg-white px-6 md:px-20">
        ...
        <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <div className='flex items-center gap-2'>
              ...
              <h3 className="text-lg font-semibold">ProcuraHub</h3>
            </div>
            <div>
